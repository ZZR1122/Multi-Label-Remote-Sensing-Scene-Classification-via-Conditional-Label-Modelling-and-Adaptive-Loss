...
def build_training_components(
    ...
    """Instantiate the conditional BCE baseline, loss, and optimizer."""
...
def train_model(
    ...
    """Run conditional BCE training and save the best validation checkpoint."""
    ...
    print("Use evaluate_conditional_bce_correlation.py for final test-set evaluation.")
...
if __name__ == "__main__":
    ...
    train_model(
        ...
        epochs=25,
        checkpoint_path="ablation_models/dinov3_bce_correlation/best_model_multilabel_bce_correlation.pth",
        train_batch_size=64,
        eval_batch_size=32,
        num_workers=4,
        learning_rate=1e-4,

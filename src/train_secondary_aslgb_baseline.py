...
# Creates the ASL-GB baseline model, loss, and optimizer.
def build_training_components(num_secondary_labels, device, learning_rate, weight_decay):
    """Instantiate the ASL-GB baseline, loss, and optimizer used by the training loop."""
...
# Trains the ASL-GB secondary-label baseline.
def train_model(
    split_dir,
    epochs,
    checkpoint_path,
    ...
    """Run ASL-GB baseline training and save the best validation checkpoint."""
    ...
    print("Use evaluate_secondary_aslgb_baseline.py for final test-set evaluation.")
...
if __name__ == "__main__":
    ...
    train_model(
        ...
        epochs=25,
        checkpoint_path="ablation_models/dinov3_aslgb_independent/best_model_multilabel_aslgb_independent.pth",
        train_batch_size=64,
        eval_batch_size=32,
        num_workers=4,
        learning_rate=1e-4,

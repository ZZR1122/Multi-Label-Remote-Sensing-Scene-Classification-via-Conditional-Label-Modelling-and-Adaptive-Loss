...
def train_model(split_dir, epochs, checkpoint_dir, train_batch_size, eval_batch_size, num_workers, learning_rate):
    ...
    best_val_metric = -1.0
    best_path = os.path.join(checkpoint_dir, "best_model_conditional_multilabel_aslgb.pth")
    ...
    print("Use evaluate_conditional_multilabel_aslgb.py for final test-set evaluation.")
